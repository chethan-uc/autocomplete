...
from query_parser.elasticsearch.tree import ElasticSearchItemFactory
from query_parser.exceptions import OrAndAndOnSameLevel
from query_parser.tree import OrOperation, AndOperation, UnknownOperation
from query_parser.tree import Word  # noqa: F401
from .tree import (
...
class ElasticsearchQueryBuilder(TreeVisitor):
    ...
    def __init__(self, default_operator=SHOULD, default_field='text',
        ...
        .. note::
            ...
            see :py:meth:`query_parser.elasticsearch.schema.SchemaAnalyzer.query_builder_options`
    ...
    def _yield_nested_children(self, parent, children):
        ...
        Raise if a OR (should) is in a AND (must) without being in parenthesis::
            ...
            Traceback (most recent call last):
                ...
            query_parser.exceptions.OrAndAndOnSameLevel: lo AND py
        """
    ...
    def __call__(self, tree):
        ...
        :param luqum.tree.Item tree: a query_parser parse tree
        :return dict:
        """
